...
class Parametros(BaseModel):
    ...
    t:           float       # Tiempo en MINUTOS (se convierte a horas internamente)
...
def ecuacion_green_ampt(F, Ks, hf, delta_theta, t_minutos):
    """
    ...
    Args:
        ...
        t_minutos: Tiempo en MINUTOS (se convierte a horas internamente)
    
    Returns:
        float: Valor de la función
    """
    try:
        # ✅ CONVERSIÓN: minutos a horas (Ks está en cm/h)
        t = t_minutos / 60
...
if __name__ == "__main__":
    ...
    print(f"║  🔗 URL Local        : http://{ip_local}:8001 ║")
    ...
    uvicorn.run(
        "server:app",      # ✅ CORREGIDO: era "main:app"
